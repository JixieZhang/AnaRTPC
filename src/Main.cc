...
int main(int argc, char** argv)
{
	...
	{
		cout<<endl;
		cout<<"Usage: exe <job(10-19)> <infile=nt.root> [outfile=nt_ep.root] [readoutpad=6(1|2|3|4|5|6)]"<<endl;
		cout<<"       exe <job(20-29)> [in_para=in_para.ini] [in_file=in_file.dat]"<<endl;
		cout<<"\nFor 10<=job<=19 or job==99:"<<endl;
		cout<<"       exe <job(10-19)> <infile=nt.root> [outfile=nt_ep.root] [readoutpad=6(1|2|3|4|5|6)]"<<endl;
